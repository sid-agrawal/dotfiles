...
** Window Helpers
Some settins inspired from [[https://github.com/daviwil/emacs-from-scratch/blob/aa344276b42f8abaf1fc7326c7ceda28ea5cf750/show-notes/Emacs-Tips-05.org#buffer-move-or-moving-buffers-between-windows][here.]] The [[https://www.youtube.com/watch?v=gbdE7oZEdtA&list=PLEoMzSkcN8oMHJ6Xil1YdnYtlWd5hHZql&index=5][is here]].
*** winner-mode
...
I have borrowed config from this [[https://codearsonist.com/reading-for-programmers][blog.]] The actual emacs config is [[https://github.com/peel/dotfiles/blob/master/overlays/20-emacs/emacs/default.el][here]]. 
...
To capture the output of a command in an emacs buffer:
#+begin_src bash :tangle no
    echo ll > #<buffer buf-name>
#+end_src
